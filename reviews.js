(() => {
  const CAVERO_CUSTOMER_REVIEWS = {
    chronos: [
      {name:'Cliente CAVERO',variant:'CAVERO Chronos Ice',rating:5,verified:false,title:'Muita presença no pulso',text:'O Chronos Ice tem mesmo muita presença no pulso. O mostrador chama logo a atenção e o acabamento ficou ainda melhor do que parecia nas fotos.',photo:'',date:''},
      {name:'Cliente CAVERO',variant:'CAVERO Chronos Ice',rating:5,verified:false,title:'Elegante e moderno',text:'Escolhi este modelo porque queria algo diferente e não me arrependi. É elegante, moderno e dá um toque muito mais cuidado ao look.',photo:'',date:''},
      {name:'Cliente CAVERO',variant:'CAVERO Chronos Ice',rating:4,verified:false,title:'Surpreendeu-me ao vivo',text:'Ao vivo surpreendeu-me bastante. O relógio parece robusto, os detalhes estão muito bem conseguidos e fica muito bem no pulso.',photo:'',date:''},
      {name:'Cliente CAVERO',variant:'CAVERO Chronos Ice',rating:5,verified:false,title:'Já recebi vários elogios',text:'Já recebi vários elogios desde que comecei a usar o Chronos Ice. É daqueles relógios que se destaca sem parecer exagerado.',photo:'',date:''},
      {name:'Cliente CAVERO',variant:'CAVERO Chronos Ice',rating:5,verified:false,title:'O cronógrafo conquistou-me',text:'O design do cronógrafo foi o que me conquistou. Tem um aspeto muito sofisticado e combina tanto com roupa casual como com algo mais formal.',photo:'',date:''},
      {name:'Cliente CAVERO',variant:'CAVERO Chronos Ice',rating:4,verified:false,title:'Personalidade sem perder elegância',text:'Estava com algum receio de ser demasiado chamativo, mas ficou perfeito. Tem personalidade sem perder a elegância.',photo:'',date:''},
      {name:'Cliente CAVERO',variant:'CAVERO Chronos Ice',rating:5,verified:false,title:'Parece um modelo mais caro',text:'A qualidade visual do relógio surpreendeu-me. Os detalhes e o contraste do mostrador fazem com que pareça um modelo bastante mais caro.',photo:'',date:''},
      {name:'Cliente CAVERO',variant:'CAVERO Chronos Ice',rating:5,verified:false,title:'Uso-o quase todos os dias',text:'Uso o Chronos Ice quase todos os dias. É confortável, tem um tamanho excelente e dá logo outro ar ao pulso.',photo:'',date:''},
      {name:'Cliente CAVERO',variant:'CAVERO Chronos Ice',rating:5,verified:false,title:'Ao vivo é outra coisa',text:'Nas fotografias já parecia bonito, mas ao vivo é outra coisa. O mostrador e os submostradores dão-lhe um visual mesmo premium.',photo:'',date:''},
      {name:'Cliente CAVERO',variant:'CAVERO Chronos Ice',rating:4,verified:false,title:'Superou as expectativas',text:'Foi uma compra que superou as expectativas. O relógio é bonito, tem presença e parece muito mais exclusivo do que eu imaginava.',photo:'',date:''}
    ],
    ocean: [],
    velocity: [],
    prestige: [],
