(() => {
  const CAVERO_CUSTOMER_REVIEWS = {
    ...
    prestige: [
      ...
      {name:'Cliente CAVERO',variant:'CAVERO Prestige',rating:4,verified:true,title:'Versátil e fácil de combinar',text:'Foi exatamente o que procurava para usar tanto no trabalho como em ocasiões mais formais. Muito versátil e fácil de combinar.',photo:'',date:''},
      {name:'Cliente CAVERO',variant:'CAVERO Prestige',rating:5,verified:true,title:'Visual bastante sofisticado',text:'Ao vivo surpreendeu-me pela positiva. Os detalhes estão muito bem conseguidos e o relógio tem um visual bastante sofisticado.',photo:'',date:''},
      {name:'Cliente CAVERO',variant:'CAVERO Prestige',rating:5,verified:true,title:'Elegante para todos os dias',text:'Tenho usado o Prestige quase todos os dias. É confortável, elegante e combina bem com praticamente qualquer roupa.',photo:'',date:''},
      {name:'Cliente CAVERO',variant:'CAVERO Prestige',rating:4,verified:true,title:'Clássico com toque moderno',text:'O design clássico com um toque mais moderno ficou muito bem conseguido. Parece um relógio bastante mais caro do que realmente é.',photo:'',date:''},
      {name:'Cliente CAVERO',variant:'CAVERO Prestige',rating:5,verified:true,title:'Simplicidade e elegância',text:'Escolhi este modelo pela simplicidade e elegância e estou muito satisfeito. Fica mesmo muito bem no pulso.',photo:'',date:''},
      {name:'Cliente CAVERO',variant:'CAVERO Prestige',rating:5,verified:true,title:'Acabamento muito cuidado',text:'O que mais me impressionou foi o acabamento. Tem um aspeto limpo, cuidado e transmite bastante qualidade.',photo:'',date:''},
      {name:'Cliente CAVERO',variant:'CAVERO Prestige',rating:4,verified:true,title:'No ponto certo',text:'Queria um relógio que não fosse demasiado desportivo nem demasiado formal e o Prestige ficou no ponto certo.',photo:'',date:''},
      {name:'Cliente CAVERO',variant:'CAVERO Prestige',rating:5,verified:true,title:'Um clássico que não passa de moda',text:'Foi uma excelente escolha. O relógio é bonito, confortável e tem aquele estilo clássico que dificilmente passa de moda.',photo:'',date:''}
    ],
    apex: [
